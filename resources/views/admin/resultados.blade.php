            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                         <!-- Aquí se mostrará el texto adicional -->
                        <h4><p class="text-center" style="color: red" id="modal-texto-adicional"></p></h4>
                        
                        <h6><p class="text-center">Está seguro de querer actualizar los
                            siguientes números?</p></h6>
                            ...
                            <div class="card">
                                ...
                                <div id="LotoReal" class="collapse" aria-labelledby="headingOne"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post" action="{{ route('real12pm.store') }}"
                                                ...
                                                <div class="form-group">
                                                      {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                  <input type="hidden" id="modal-texto-adicional" value="Lotería Real, Sorteo 12:55 PM">
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                      {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                  <input type="hidden" id="modal-texto-adicional" value="LotoPool Real">
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                     {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                  <input type="hidden" id="modal-texto-adicional" value="Pega 4 Real">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="0" min="0" max="1" maxlength="1"
                                                        pattern="\d+" title="Solo se permiten números" name="num1"
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                      {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                  <input type="hidden" id="modal-texto-adicional" value="Nueva Yol Real">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99" maxlength="2"
                                                        pattern="\d+" title="Solo se permiten números" name="num1"
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                  <input type="hidden" id="modal-texto-adicional" value="Tu Fecha Real">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="2" maxlength="2"
                                                        pattern="\d+" title="Solo se permiten números" name="num1"
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                     {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Loto Real">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99" maxlength="2"
                                                        pattern="\d+" title="Solo se permiten números" name="num1"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Lotería Nacional, Sorteo 2:30 PM">
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Lotería Nacional, Sorteo 8:50 PM">
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Juega + Pega +">
                                        ...
                                        <div class="sorteo mb-6">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Billetes Domingo">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="King Lottery, Sorteo 12:30 PM">
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                     {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                     <input type="hidden" id="modal-texto-adicional" value="King Lottery, Sorteo 7:30 PM">
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Philisburg King Lottery 12:30 PM">
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Philisburg King Lottery 7:30 PM">
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Loto Pool King Lottery 12:30 PM">
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Loto Pool King Lottery 7:30 PM">

                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                                        name="num1" required {{ $estatus_lotopoolking730pm->estatus }}>
                                                </div>
                                                <div class="form-group">
                                                    <label for="input2" class="mr-3">Resultado 2:</label>
                                                    <input type="text" class="form-control mr-3" id="input2"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                                        name="num2" required {{ $estatus_lotopoolking730pm->estatus }}>
                                                </div>
                                                <div class="form-group">
                                                    <label for="input3" class="mr-3">Resultado 3:</label>
                                                    <input type="text" class="form-control mr-3" id="input3"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                                        name="num3" required {{ $estatus_lotopoolking730pm->estatus }}>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control mr-3" id="input4"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                                        name="num4" required {{ $estatus_lotopoolking730pm->estatus }}>
                                                </div>

                                                <!-- Button trigger modal -->
                                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                                    data-target="#loterias-modal"
                                                    onclick="pasarDatos('lotopoolking730')" id="miBoton" {{ $estatus_lotopoolking730pm->estatus }}>
                                                    Actualizar
                                                </button>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Leidsa, Sorteo 8:55PM Lun/Sab - Los Domingos 3:55PM">
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Pega 3 Mas">
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Loto Pool">
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Super Kino TV">
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Super Loto Mas">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Quemaito Mayor">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Agarra 4">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Quiniela Lotedom">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="La Primera, Sorteo 12:00PM Lun/Dom">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                     {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                     <input type="hidden" id="modal-texto-adicional" value="La Primera, Sorteo 8:00PM Lun/Dom">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group mb-3">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Loto 5 Mas Primera">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Loteka, Sorteo 7:55PM Lun/Dom">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group mb-3">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Loto Loteka">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Mega Chance">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Repartidera Mega Chance">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Quiniela Loteka">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Toca 3">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                     {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                     <input type="hidden" id="modal-texto-adicional" value="La Suerte Dominicana, Sorteo 12:30PM Lun/Dom">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                      {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                      <input type="hidden" id="modal-texto-adicional" value="La Suerte Dominicana, Sorteo 6:00PM Lun/Dom">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="New York Lottery, Sorteo 2:30 PM">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="000" min="0" max="99"
                                                        maxlength="3" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="New York Lottery, Sorteo 10:30PM Lun/Dom">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="000" min="0" max="99"
                                                        maxlength="3" pattern="\d+" title="Solo se permiten números"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Florida Lottery, Sorteo 1:30PM Lun/Dom">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="000" min="0" max="99"
                                                        maxlength="3" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Florida Lottery, Sorteo 9:40PM Lun/Dom">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="000" min="0" max="99"
                                                        maxlength="3" pattern="\d+" title="Solo se permiten números"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Anguilla Lottery 9:00 AM">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Anguilla Lottery 10:00 AM">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Anguilla Lottery 11:00 AM">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Anguilla Lottery 12:00 PM">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Anguilla Lottery 1:00 PM">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Anguilla Lottery 2:00 PM">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Anguilla Lottery 3:00 PM">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Anguilla Lottery 4:00 PM">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Anguilla Lottery 5:00 PM">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Anguilla Lottery 6:00 PM">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Anguilla Lottery 7:00 PM">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Anguilla Lottery 8:00 PM">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Anguilla Lottery 9:00 PM">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Cuarteta - Anguilla Lottery 9:00 AM.">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Cuarteta - Anguilla Lottery 10:00 AM.">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Cuarteta - Anguilla Lottery 11:00 AM.">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Cuarteta - Anguilla Lottery 12:00 PM.">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Cuarteta - Anguilla Lottery 1:00 PM.">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Cuarteta - Anguilla Lottery 2:00 PM.">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Cuarteta - Anguilla Lottery 3:00 PM.">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Cuarteta - Anguilla Lottery 4:00 PM.">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4 form-dia">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                     {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                     <input type="hidden" id="modal-texto-adicional" value="Cuarteta - Anguilla Lottery 5:00 PM.">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Cuarteta - Anguilla Lottery 6:00 PM.">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Cuarteta - Anguilla Lottery 7:00 PM.">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                    {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                    <input type="hidden" id="modal-texto-adicional" value="Cuarteta - Anguilla Lottery 8:00 PM.">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
                                        ...
                                        <div class="sorteo mb-4">
                                            ...
                                            <form class="form-inline" method="post"
                                                ...
                                                <div class="form-group">
                                                     {{-- OJO HE AGREGADO ESTO para el texto que muestra la loteria en la modal--}}
                                                  <input type="hidden" id="modal-texto-adicional" value="Cuarteta - Anguilla Lottery 9:00 PM.">
                                                    <label for="input1" class="mr-3">Resultado 1:</label>
                                                    <input type="text" class="form-control mr-3" id="input1"
                                                        placeholder="00" min="0" max="99"
                                                        maxlength="2" pattern="\d+" title="Solo se permiten números"
...
@section('js')
    ...
    <script>
        function pasarDatos(id) {
            ...
            // Obtener el texto adicional del formulario
            const textoAdicional = formEle.querySelector("#modal-texto-adicional").value;

            // Mostrar el texto adicional en la modal
            document.getElementById("modal-texto-adicional").innerText = textoAdicional;
