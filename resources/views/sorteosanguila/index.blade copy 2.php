                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        @foreach ($anguilla as $anguill)
                            <tr>
                                <td class="fw-bold">{{ Carbon\Carbon::parse($anguill->created_at)->setTimezone('-00:00')->format('d/m/Y g:00 A') }}</td>

                                <td class="fw-bold">                                   
                                    <div class="d-flex justify-content-center align-items-center">
                                        <div class="circulo-naranja" style="font-size: 1rem">{{ $anguill->num1 }}</div>
                                        <div class="circulo-naranja" style="font-size: 1rem">{{ $anguill->num2 }}</div>
                                        <div class="circulo-naranja" style="font-size: 1rem">{{ $anguill->num3 }}</div>
                                    </div>
